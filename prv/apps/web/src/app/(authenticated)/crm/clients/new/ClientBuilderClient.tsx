...
export function ClientBuilderClient() {
  ...
  const [form, setForm] = useState<FormState>({ name: "", type: "business", email: "", phone: "", city: "", vatNumber: "", address: "", notes: "" })
      ...
      <div style={{ minHeight: "100vh", background: "#000", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
        <div style={{ ...GLASS_CARD, padding: 40, textAlign: "center", maxWidth: 400 }}>
          ...
          <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
            <button style={BTN_PRIMARY} onClick={() => router.push("/crm/clients")}>← Înapoi la listă</button>
            <button style={BTN_GHOST} onClick={() => { setDone(false); setForm({ name: "", type: "business", email: "", phone: "", city: "", vatNumber: "", address: "", notes: "" }) }}>+ Creează altul</button>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#000", padding: "24px 16px 120px" }}>
      <div style={{ maxWidth: 600, margin: "0 auto" }}>
        ...
        <h1 style={{ color: "rgba(255,255,255,0.95)", fontSize: 28, fontWeight: 700, marginBottom: 32 }}>Client Nou</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input style={FIELD} value={form.name as string} onChange={e => set(e, "name")} type="text" placeholder="Denumire client sau companie" required />
          </div>
          <div>
            ...
            <select style={SELECT} value={form.type as string} onChange={e => set(e, "type")}>
              ...
              <option value="business">Companie</option>
            </select>
          </div>
          <div>
          ...
          <div>
            ...
            <textarea style={{...FIELD, minHeight: 120}} value={form.notes as string} onChange={e => set(e, "notes")} />
          </div>
          </div>
