...
const DOCUMENTS: Document[] = [
  {
    id: "doc-1", name: "Contract_Renovare_Cluj14.pdf", ext: "PDF", category: "Contracts",
    author: "Andrei Popescu", date: "Jun 5", size: "1.2 MB", status: "Signed",
    project: "Renovation Cluj #14", signedBy: "2 of 2 parties", validUntil: "Dec 31, 2026", version: "v3 · Final",
    activity: [
  ...
  {
    id: "doc-2", name: "Factura_2026_0194.pdf", ext: "PDF", category: "Invoices",
    author: "Auto-generated", date: "Jun 6", size: "0.4 MB", status: "Pending",
    project: "Renovation Cluj #14", signedBy: "0 of 1 parties", validUntil: "Jul 6, 2026", version: "v1",
    activity: [
      { label: "Invoice generated", detail: "Jun 6, 08:00 · Auto", color: "rgba(48,209,88,0.95)" },
      { label: "Sent to client", detail: "Jun 6, 08:01 · Via email", color: "rgba(10,132,255,0.9)" },
    ],
  },
  {
    id: "doc-3", name: "Brief_Proiect_TM07.docx", ext: "DOC", category: "Projects",
    author: "Elena Marin", date: "Jun 4", size: "0.8 MB", status: "Draft",
  ...
  {
    id: "doc-4", name: "Contract_Munca_LT_2026.pdf", ext: "PDF", category: "HR",
    author: "Maria Ionescu", date: "Jun 3", size: "0.6 MB", status: "Signed",
    project: "HR · Liviu Toma", signedBy: "2 of 2 parties", validUntil: "Dec 31, 2026", version: "v1 · Final",
    activity: [
  ...
  {
    id: "doc-5", name: "Asigurare_B44PRV_2025.pdf", ext: "PDF", category: "Fleet",
    author: "System", date: "Dec 31 2025", size: "0.3 MB", status: "Expired",
...
function docIconStyle(doc: Document) {
  ...
  if (selected) {
    ...
    return (
      <div style={{ padding: "32px 16px 120px", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', sans-serif", WebkitFontSmoothing: "antialiased" }}>
        ...
        {/* Details */}
        <p style={{ fontSize: 11, fontWeight: 600, color: t3, textTransform: "uppercase", letterSpacing: "0.07em", margin: "0 2px 10px" }}>Details</p>
        <div style={card}>
          <TopEdge />
          {[
        ...
        {/* Activity */}
        <p style={{ fontSize: 11, fontWeight: 600, color: t3, textTransform: "uppercase", letterSpacing: "0.07em", margin: "18px 2px 10px" }}>Activity</p>
        <div style={card}>
          <TopEdge />
  ...
  return (
    <div style={{ padding: "32px 16px 120px", fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', sans-serif", WebkitFontSmoothing: "antialiased" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 8, marginBottom: 14 }}>
        {CATEGORIES.map(cat => (
          <div key={cat.label} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, padding: "12px 4px", borderRadius: 14, background: g1, border: `1px solid ${bds}`, cursor: "pointer" }}>
            <div style={{ width: 32, height: 32, borderRadius: 10, background: cat.bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={cat.stroke} strokeWidth="1.8" strokeLinecap="round">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" />
              </svg>
            </div>
            <div style={{ fontSize: 10, fontWeight: 600, color: t2, textAlign: "center" }}>{cat.label}</div>
      ...
      <div style={card}>
        <TopEdge />
        {filtered.length === 0 ? (
          <div style={{ padding: "24px 16px", textAlign: "center", color: t3, fontSize: 13 }}>No documents found</div>
        ) : (
          filtered.map((doc, i) => {
            const { bg, color } = docIconStyle(doc)
            return (
