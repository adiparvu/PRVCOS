...
export function DashboardGreeting({ name, tasksToday }: DashboardGreetingProps) {
  ...
  useEffect(() => {
    // Set the client clock after mount to avoid an SSR hydration mismatch.
  ...
  return (
    <div className="flex gap-3 mb-3.5">
      ...
      >
        <div className="text-[13px]" style={{ color: "var(--prv-text-3)" }}>
          {greeting},
        </div>
        <div
