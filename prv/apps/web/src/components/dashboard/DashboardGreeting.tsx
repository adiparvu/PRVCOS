...
export function DashboardGreeting({ name, tasksToday }: DashboardGreetingProps) {
  ...
  return (
    <div className="flex gap-3 mb-3.5">
      ...
      >
        <div className="text-[13px] text-white/35">{greeting},</div>
        <div className="text-[20px] font-bold tracking-tight mt-0.5">{name ?? "there"} 👋</div>
      ...
      >
        ...
        <div className="text-[20px] font-bold">{PLACEHOLDER_WEATHER.temp}°</div>
